  ...
  Todo.findByPk(id)
    ...
    .catch((err) => {
      req.session.messages = [
        { message: "Tarefa não encontrada!", type: "error" },
      ];
      return res.redirect("/");
    });
});
...
app.post("/edit", (req, res) => {
  ...
  Todo.update(
    ...
    .catch((err) => {
      req.session.messages = [
        { message: "Erro ao atualizar tarefa!", type: "error" },
      ];
      return res.redirect("/");
    });
});
...
app.post("/close", (req, res) => {
  const id = req.body.id;
  Todo.update({ open: false }, { where: { id: id } })
    .then(() => {
    ...
    .catch((err) => {
      req.session.messages = [
        { message: "Erro ao fechar a tarefa!", type: "error" },
      ];
      return res.redirect("/");
    });
});
...
app.post("/delete", (req, res) => {
  ...
  Todo.destroy({ where: { id: id } })
    ...
    .catch((err) => {
      req.session.messages = [
        { message: "Erro ao deletar tarefa!", type: "error" },
      ];
      return res.redirect("/");
    });
});
